    ...
    <div class="content-wrap">
      ...
      <div class="table-wrap">
        ...
        <el-table :data="data" style="width: 100%" border stripe highlight-current-row @selection-change="selsChange" :header-cell-style="{textAlign: 'center'}" :cell-style="{textAlign: 'center'}">
          ...
          <el-table-column type="index" label="序号" prop="taskNumber">
          </el-table-column>
        ...
        <!--工具条-->
        <el-pagination align="right" background layout="prev, pager, next" @current-change="handleCurrentChange" :page-size="20" :total="total">
        </el-pagination>
      </div>
